...
/**
 * i have one java problem matrix related. command[1,1,2] 1st first command (1)
 * the given array which layer should rotate, like 1st layer, 2nd layer,etc 2nd
 * second command (1) positive means right roate or -1 means left roate 3rd thid
 * command (2) means how many times will rotate.
 * 
 * 
 * given example [1,1,2]
 * 
...
public class MatrixLayerRotation {
	public static void main(String[] args) {
		...
		int[] command = { 1, 1, 2 }; // 1 layer 1, right rotate, 2 times
	...
	public static void rotateMatrix(int[][] matrix, int[] command) {
		...
		times = times % len;
		if (direction == -1)
			times = len - times; // convert left rotation to right
